...
class TimeSeriesDay(object):
    ...
    swagger_types = {
        ...
        'crude_unit_utilization_percentage': 'TimeseriesCrudeUnitUtilization',
    ...
    attribute_map = {
        'crudes': 'crudes',
        'crude_unit_utilization_percentage': 'crudeUnitUtilizationPercentage',
        'product_prices': 'productPrices',
        'run_mode': 'runMode',
        'advanced_options': 'advancedOptions'
    }

    def __init__(self, crudes=None, crude_unit_utilization_percentage=None, product_prices=None, run_mode=None, advanced_options=None):  # noqa: E501
        """TimeSeriesDay - a model defined in Swagger"""  # noqa: E501
        self._crudes = None
        self._crude_unit_utilization_percentage = None
        ...
        if crudes is not None:
            self.crudes = crudes
        if crude_unit_utilization_percentage is not None:
            self.crude_unit_utilization_percentage = crude_unit_utilization_percentage
    ...
    @property
    def crude_unit_utilization_percentage(self):
        """Gets the crude_unit_utilization_percentage of this TimeSeriesDay.  # noqa: E501


        :return: The crude_unit_utilization_percentage of this TimeSeriesDay.  # noqa: E501
        :rtype: TimeseriesCrudeUnitUtilization
        """
        return self._crude_unit_utilization_percentage

    @crude_unit_utilization_percentage.setter
    def crude_unit_utilization_percentage(self, crude_unit_utilization_percentage):
        """Sets the crude_unit_utilization_percentage of this TimeSeriesDay.


        :param crude_unit_utilization_percentage: The crude_unit_utilization_percentage of this TimeSeriesDay.  # noqa: E501
        :type: TimeseriesCrudeUnitUtilization
        """

        self._crude_unit_utilization_percentage = crude_unit_utilization_percentage
