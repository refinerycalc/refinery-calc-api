...
class OutputTypes(object):
    ...
    swagger_types = {
        ...
        'catalyst_condition': 'list[OutputDetails]',
        'co2_emissions': 'list[OutputDetails]',
        ...
        'unit_co2_emissions': 'list[OutputDetails]',
        'crude_gpw': 'list[OutputDetails]',
        'unit_utilization': 'list[OutputDetails]',
        'unspecified': 'list[OutputDetails]'
    }

    attribute_map = {
        'balance': 'balance',
        'catalyst_condition': 'catalystCondition',
        ...
        'unit_co2_emissions': 'unitCo2Emissions',
        'crude_gpw': 'crudeGPW',
        'unit_utilization': 'unitUtilization',
        'unspecified': 'unspecified'
    }

    def __init__(self, balance=None, catalyst_condition=None, co2_emissions=None, complexity=None, constraints=None, crude_names=None, crude_percent=None, crude_pricing=None, crude_quality=None, crudes_and_feeds=None, delete_category=None, economics=None, end_points_f=None, expense_factors=None, fcc_hydrk_conv=None, feeds_pricing=None, gasoline_blending=None, general=None, hydrogen=None, product_pricing=None, products=None, refinery_layout_svg=None, sustainability=None, unit_balance=None, unit_co2_emissions=None, crude_gpw=None, unit_utilization=None, unspecified=None):  # noqa: E501
        """OutputTypes - a model defined in Swagger"""  # noqa: E501
        self._balance = None
        self._catalyst_condition = None
        ...
        self._unit_co2_emissions = None
        self._crude_gpw = None
        self._unit_utilization = None
        self._unspecified = None
        self.discriminator = None
        if balance is not None:
            self.balance = balance
        if catalyst_condition is not None:
            self.catalyst_condition = catalyst_condition
        ...
        if unit_co2_emissions is not None:
            self.unit_co2_emissions = unit_co2_emissions
        if crude_gpw is not None:
            self.crude_gpw = crude_gpw
        if unit_utilization is not None:
            self.unit_utilization = unit_utilization
    ...
    @property
    def catalyst_condition(self):
        """Gets the catalyst_condition of this OutputTypes.  # noqa: E501


        :return: The catalyst_condition of this OutputTypes.  # noqa: E501
        :rtype: list[OutputDetails]
        """
        return self._catalyst_condition

    @catalyst_condition.setter
    def catalyst_condition(self, catalyst_condition):
        """Sets the catalyst_condition of this OutputTypes.


        :param catalyst_condition: The catalyst_condition of this OutputTypes.  # noqa: E501
        :type: list[OutputDetails]
        """

        self._catalyst_condition = catalyst_condition

    @property
    def co2_emissions(self):
        """Gets the co2_emissions of this OutputTypes.  # noqa: E501


        :return: The co2_emissions of this OutputTypes.  # noqa: E501
        :rtype: list[OutputDetails]
        """
    ...
    def co2_emissions(self, co2_emissions):
        """Sets the co2_emissions of this OutputTypes.


        :param co2_emissions: The co2_emissions of this OutputTypes.  # noqa: E501
        :type: list[OutputDetails]
        """
    ...
    @property
    def unit_co2_emissions(self):
        """Gets the unit_co2_emissions of this OutputTypes.  # noqa: E501


        :return: The unit_co2_emissions of this OutputTypes.  # noqa: E501
        :rtype: list[OutputDetails]
        """
        return self._unit_co2_emissions

    @unit_co2_emissions.setter
    def unit_co2_emissions(self, unit_co2_emissions):
        """Sets the unit_co2_emissions of this OutputTypes.


        :param unit_co2_emissions: The unit_co2_emissions of this OutputTypes.  # noqa: E501
        :type: list[OutputDetails]
        """

        self._unit_co2_emissions = unit_co2_emissions

    @property
    def crude_gpw(self):
        """Gets the crude_gpw of this OutputTypes.  # noqa: E501


        :return: The crude_gpw of this OutputTypes.  # noqa: E501
        :rtype: list[OutputDetails]
        """
    ...
    def crude_gpw(self, crude_gpw):
        """Sets the crude_gpw of this OutputTypes.


        :param crude_gpw: The crude_gpw of this OutputTypes.  # noqa: E501
        :type: list[OutputDetails]
        """
    ...
    @property
    def unit_utilization(self):
        """Gets the unit_utilization of this OutputTypes.  # noqa: E501


        :return: The unit_utilization of this OutputTypes.  # noqa: E501
        :rtype: list[OutputDetails]
        """
        return self._unit_utilization

    @unit_utilization.setter
    def unit_utilization(self, unit_utilization):
        """Sets the unit_utilization of this OutputTypes.


        :param unit_utilization: The unit_utilization of this OutputTypes.  # noqa: E501
        :type: list[OutputDetails]
        """

        self._unit_utilization = unit_utilization

    @property
    def unspecified(self):
        """Gets the unspecified of this OutputTypes.  # noqa: E501


        :return: The unspecified of this OutputTypes.  # noqa: E501
        :rtype: list[OutputDetails]
        """
    ...
    def unspecified(self, unspecified):
        """Sets the unspecified of this OutputTypes.


        :param unspecified: The unspecified of this OutputTypes.  # noqa: E501
        :type: list[OutputDetails]
        """
