...
class RefineryOutputTypeModel(object):
    ...
    attribute_map = {
        ...
        'time_travel_period': 'timeTravelPeriod',
        'output': 'output'
    }

    def __init__(self, refinery_id=None, refinery_name=None, percent_solved=None, start_time=None, stop_time=None, duration_in_seconds=None, time_travel_period=None, output=None):  # noqa: E501
        ...
        if time_travel_period is not None:
            self.time_travel_period = time_travel_period
    ...
    @property
    def time_travel_period(self):
        """Gets the time_travel_period of this RefineryOutputTypeModel.  # noqa: E501


        :return: The time_travel_period of this RefineryOutputTypeModel.  # noqa: E501
        :rtype: str
        """
        return self._time_travel_period

    @time_travel_period.setter
    def time_travel_period(self, time_travel_period):
        """Sets the time_travel_period of this RefineryOutputTypeModel.


        :param time_travel_period: The time_travel_period of this RefineryOutputTypeModel.  # noqa: E501
        :type: str
        """

        self._time_travel_period = time_travel_period
