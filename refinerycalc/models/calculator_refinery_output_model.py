...
class CalculatorRefineryOutputModel(object):
    ...
    attribute_map = {
        ...
        'time_travel_date': 'timeTravelDate'
    }

    def __init__(self, id=None, refinery_name=None, output_type=None, name=None, value=None, description=None, unit_of_measure=None, display_order=None, day_number=None, calculator_refinery_id=None, time_travel_date=None):  # noqa: E501
        ...
        if time_travel_date is not None:
    ...
    @property
    def time_travel_date(self):
        """Gets the time_travel_date of this CalculatorRefineryOutputModel.  # noqa: E501


        :return: The time_travel_date of this CalculatorRefineryOutputModel.  # noqa: E501
        :rtype: datetime
        """
        return self._time_travel_date

    @time_travel_date.setter
    def time_travel_date(self, time_travel_date):
        """Sets the time_travel_date of this CalculatorRefineryOutputModel.


        :param time_travel_date: The time_travel_date of this CalculatorRefineryOutputModel.  # noqa: E501
        :type: datetime
        """

        self._time_travel_date = time_travel_date
