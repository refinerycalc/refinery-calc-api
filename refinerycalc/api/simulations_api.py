...
class SimulationsApi(object):
    ...
    def v1_simulations_get(self, **kwargs):  # noqa: E501
        ...
        :param GetSimulationRequestModel body:
    ...
    def v1_simulations_id_refineries_crudes_patch(self, id, **kwargs):  # noqa: E501
        """Update Crudes for One or More Refineries  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_simulations_id_refineries_crudes_patch(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str id: simulation id (required)
        :param UpdateSimulationRefineryCrudeRequest body: the list of refineries with refinery crude ids and crudes
        :return: ApiResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v1_simulations_id_refineries_crudes_patch_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.v1_simulations_id_refineries_crudes_patch_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def v1_simulations_id_refineries_crudes_patch_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update Crudes for One or More Refineries  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_simulations_id_refineries_crudes_patch_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_simulations_id_refineries_crudes_patch" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `v1_simulations_id_refineries_crudes_patch`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/simulations/{id}/refineries/crudes', 'PATCH',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def v1_simulations_id_run_post(self, id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str id: simulation id (required)
        :param RunSimulationRequestModel body:
